...
var statement = (function (jsBase) {
    ...
    statement.prototype.loadChild = function(child) {
        ...
        if (name === 'module') {
            return this.wzLoadToChildColl(child, _md.xmodule, this.statements);
        }
        if (name === 'oncopy') {
...
*/
var xmodule = (function (statement) {
    _inherits(xmodule, statement);
    function xmodule(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(xmodule.prototype), 'constructor', this).call(this, name,sourceLineInfo);
    ...
    xmodule.KIND_JSFILE = "jsfile";xmodule.KIND_NODEJS_BIN = "nodejs.bin";xmodule.KIND_REACT = "react";xmodule.KIND_ES6 = "es6";xmodule.ECMA_ES5 = "es5";xmodule.ECMA_ES6 = "es6";xmodule.prototype.addFeature = function(name, sourceLineInfo) {
        var retval = new _md.feature(name, sourceLineInfo);
        retval.wzParent = this;
        this.features.push(retval);
        return retval;
    }
    xmodule.prototype.getFeature = function(name) {
        var found = null;
    ...
    xmodule.prototype.loadChild = function(child) {
    ...
    xmodule.prototype.loadFromNode = function(node) {
        node.children.forEach((item) => {
            var loaded = this.loadChild(item);
            if (!loaded) {
                throw new _md.jsModelException("Tag not recognized: " + item.n, item, this);
    ...
    xmodule.prototype.wzVerify = function(ctx) {
        ctx.verifyEnum("xmodule", "kind", this.kind, this.allowedKINDS, this);
        ctx.verifyEnum("xmodule", "ecma", this.ecma, this.allowedECMAS, this);
        this.features.forEach((item) => {
            item.wzVerify(ctx);
        });
        _md.statement.prototype.wzVerify.call(this, ctx);
    }
    xmodule.prototype.wzInitialize = function(ctx) {
        this.features.forEach((item) => {
            item.wzInitialize(ctx);
        });
    ...
    xmodule.prototype.hasFeature = function(name) {
