...
md.__preload_js_model = require("./lib/wizzi/models/js-model.g");
md.__preload_js_factory = require("./lib/wizzi/models/js-factory.g");
md.__preload_js_module_gen = require("./lib/artifacts/js/module/gen/main");
md.__preload_ts_model = require("./lib/wizzi/models/ts-model.g");
md.__preload_ts_factory = require("./lib/wizzi/models/ts-factory.g");
md.__preload_ts_module_gen = require("./lib/artifacts/ts/module/gen/main");
//
