...
var fontface = (function (rule) {
    ...
    fontface.prototype.loadChild = function(child) {
        ...
        if (name === 'font-stretch') {
            ...
            this.fontDisplay = child.v; return true;
        }
        else if (name === 'font_display') {
            this.fontDisplay = child.v; return true;
        }
        ...
        if (name === 'font-feature-settings') {
            this.fontFeatureSettings = child.v; return true;
        }
        else if (name === 'font_feature_settings') {
            this.fontFeatureSettings = child.v; return true;
        }
        if (name === 'font-variation-settings') {
            this.fontVariationSettings = child.v; return true;
        }
        else if (name === 'font_variation_settings') {
            this.fontVariationSettings = child.v; return true;
        }
        ok = _md.rule.prototype.loadChild.call(this, child);
        return ok;
