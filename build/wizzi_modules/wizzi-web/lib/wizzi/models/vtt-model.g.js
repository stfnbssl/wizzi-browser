...
var rule = (function (comment) {
    ...
    rule.prototype.loadChild = function(child) {
        ...
        if (name === 'gap') {
            return this.wzLoadToChildColl(child, _md.gap, this.properties);
        }
        if (name === 'top') {
        ...
        if (name === 'clippath') {
            return this.wzLoadToChildColl(child, _md.clip_path, this.properties);
        }
        else if (name === 'cueafter') {
        ...
        if (name === 'margintop') {
            ...
            return this.wzLoadToChildColl(child, _md.mask_image, this.properties);
        }
        ...
        if (name === 'caretcolor') {
            return this.wzLoadToChildColl(child, _md.caret_color, this.properties);
        }
        else if (name === 'columnfill') {
        ...
        else if (name === 'fontsmooth') {
            return this.wzLoadToChildColl(child, _md.font_smooth, this.properties);
        }
        if (name === 'gridrowgap') {
        ...
        else if (name === 'fontkerning') {
            return this.wzLoadToChildColl(child, _md.font_kerning, this.properties);
        }
        ...
        else if (name === 'font-smooth') {
            return this.wzLoadToChildColl(child, _md.font_smooth, this.properties);
        }
        else if (name === 'fontstretch') {
            return this.wzLoadToChildColl(child, _md.font_stretch, this.properties);
        }
        else if (name === 'fontvariant') {
            return this.wzLoadToChildColl(child, _md.font_variant, this.properties);
        }
        ...
        if (name === 'speakheader') {
            ...
            return this.wzLoadToChildColl(child, _md.stroke_width, this.properties);
        }
        if (name === 'tablelayout') {
        ...
        else if (name === 'fontsynthesis') {
            return this.wzLoadToChildColl(child, _md.font_synthesis, this.properties);
        }
        ...
        else if (name === 'textfillcolor') {
            return this.wzLoadToChildColl(child, _md.text_fill_color, this.properties);
        }
        ...
        if (name === 'backdropfilter') {
            return this.wzLoadToChildColl(child, _md.backdrop_filter, this.properties);
        }
        else if (name === 'backgroundclip') {
        ...
        if (name === 'flex-direction') {
            ...
            return this.wzLoadToChildColl(child, _md.font_size_adjust, this.properties);
        }
        ...
        if (name === 'scrollbarcolor') {
            return this.wzLoadToChildColl(child, _md.scrollbar_color, this.properties);
        }
        else if (name === 'scrollbarwidth') {
            return this.wzLoadToChildColl(child, _md.scrollbar_width, this.properties);
        }
        else if (name === 'scrollbarwidth') {
            return this.wzLoadToChildColl(child, _md.scrollbar_width, this.properties);
        }
        ...
        if (name === 'fontvariantcaps') {
            return this.wzLoadToChildColl(child, _md.font_variant_caps, this.properties);
        }
        ...
        if (name === 'scrollpaddingtop') {
            return this.wzLoadToChildColl(child, _md.scroll_padding_top, this.properties);
        }
        else if (name === 'speakpunctuation') {
        ...
        if (name === 'fontopticalsizing') {
            return this.wzLoadToChildColl(child, _md.font_optical_sizing, this.properties);
        }
        ...
        if (name === 'fontvariantnumeric') {
            return this.wzLoadToChildColl(child, _md.font_variant_numeric, this.properties);
        }
        ...
        if (name === 'overscrollbehavior') {
            return this.wzLoadToChildColl(child, _md.overscroll_behavior, this.properties);
        }
        ...
        else if (name === 'fontvariantposition') {
            return this.wzLoadToChildColl(child, _md.font_variant_position, this.properties);
        }
        ...
        if (name === 'fontlanguageoverride') {
            return this.wzLoadToChildColl(child, _md.font_language_override, this.properties);
        }
        else if (name === 'fontvarianteastasian') {
            return this.wzLoadToChildColl(child, _md.font_variant_east_asian, this.properties);
        }
        else if (name === 'fontvariantligatures') {
            return this.wzLoadToChildColl(child, _md.font_variant_ligatures, this.properties);
        }
        ...
        else if (name === 'fontvariationsettings') {
            return this.wzLoadToChildColl(child, _md.font_variation_settings, this.properties);
        }
        else if (name === 'fontvariantalternates') {
            return this.wzLoadToChildColl(child, _md.font_variant_alternates, this.properties);
        }
...
_md.azimuth = azimuth;
// element backdrop_filter
var backdrop_filter = (function (property) {
    _inherits(backdrop_filter, property);
    function backdrop_filter(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(backdrop_filter.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, backdrop_filter);
        this.wzElement = "backdrop_filter";
    }
    backdrop_filter.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    backdrop_filter.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    backdrop_filter.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return backdrop_filter;
})(property);

_md.backdrop_filter = backdrop_filter;
// element background
...
// element caret_color
var caret_color = (function (property) {
    _inherits(caret_color, property);
    function caret_color(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(caret_color.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, caret_color);
        this.wzElement = "caret_color";
    }
    caret_color.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    caret_color.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    caret_color.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return caret_color;
})(property);

_md.caret_color = caret_color;
// element clear
...
_md.clip = clip;
// element clip_path
var clip_path = (function (property) {
    _inherits(clip_path, property);
    function clip_path(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(clip_path.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, clip_path);
        this.wzElement = "clip_path";
    }
    clip_path.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    clip_path.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    clip_path.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return clip_path;
})(property);

_md.clip_path = clip_path;
// element color
...
var font = (function (property) {
    ...
    font.prototype.toJsonProperties = function(result) {
        ...
        if (!isEmpty(this.smooth)) {
            result["smooth"] = this.smooth;
        }
        if (!isEmpty(this.stretch)) {
            result["stretch"] = this.stretch;
        }
        if (!isEmpty(this.synthesis)) {
    ...
    font.prototype.loadChild = function(child) {
        ...
        if (name === 'smooth') {
            this.smooth = child.v; return true;
        }
        if (name === 'weight') {
        ...
        if (name === 'stretch') {
            this.stretch = child.v; return true;
        }
        if (name === 'variant') {
            this.variant = child.v; return true;
        }
        if (name === 'synthesis') {
            this.synthesis = child.v; return true;
        }
        ok = _md.property.prototype.loadChild.call(this, child);
        return ok;
    }
...
var font_feature_settings = (function (property) {
    ...
    font_feature_settings.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_feature_settings.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_feature_settings.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
...
// element font_kerning
var font_kerning = (function (property) {
    _inherits(font_kerning, property);
    function font_kerning(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_kerning.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_kerning);
        this.wzElement = "font_kerning";
    }
    font_kerning.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_kerning.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_kerning.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_kerning;
})(property);

_md.font_kerning = font_kerning;
// element font_size
...
var font_variation_settings = (function (property) {
    _inherits(font_variation_settings, property);
    function font_variation_settings(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variation_settings.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variation_settings);
        this.wzElement = "font_variation_settings";
    }
    font_variation_settings.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variation_settings.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variation_settings.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variation_settings;
})(property);

_md.font_variation_settings = font_variation_settings;
// element font_weight
...
// element font_language_override
var font_language_override = (function (property) {
    _inherits(font_language_override, property);
    function font_language_override(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_language_override.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_language_override);
        this.wzElement = "font_language_override";
    }
    font_language_override.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_language_override.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_language_override.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_language_override;
})(property);

_md.font_language_override = font_language_override;
// element font_optical_sizing
var font_optical_sizing = (function (property) {
    _inherits(font_optical_sizing, property);
    function font_optical_sizing(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_optical_sizing.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_optical_sizing);
        this.wzElement = "font_optical_sizing";
    }
    font_optical_sizing.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_optical_sizing.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_optical_sizing.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_optical_sizing;
})(property);

_md.font_optical_sizing = font_optical_sizing;
// element font_size_adjust
var font_size_adjust = (function (property) {
    _inherits(font_size_adjust, property);
    function font_size_adjust(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_size_adjust.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_size_adjust);
        this.wzElement = "font_size_adjust";
    }
    font_size_adjust.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_size_adjust.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_size_adjust.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_size_adjust;
})(property);

_md.font_size_adjust = font_size_adjust;
// element font_smooth
var font_smooth = (function (property) {
    _inherits(font_smooth, property);
    function font_smooth(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_smooth.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_smooth);
        this.wzElement = "font_smooth";
    }
    font_smooth.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_smooth.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_smooth.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_smooth;
})(property);

_md.font_smooth = font_smooth;
// element font_stretch
var font_stretch = (function (property) {
    _inherits(font_stretch, property);
    function font_stretch(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_stretch.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_stretch);
        this.wzElement = "font_stretch";
    }
    font_stretch.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_stretch.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_stretch.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_stretch;
})(property);

_md.font_stretch = font_stretch;
// element font_synthesis
var font_synthesis = (function (property) {
    _inherits(font_synthesis, property);
    function font_synthesis(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_synthesis.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_synthesis);
        this.wzElement = "font_synthesis";
    }
    font_synthesis.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_synthesis.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_synthesis.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_synthesis;
})(property);

_md.font_synthesis = font_synthesis;
// element font_variant_alternates
var font_variant_alternates = (function (property) {
    _inherits(font_variant_alternates, property);
    function font_variant_alternates(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variant_alternates.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variant_alternates);
        this.wzElement = "font_variant_alternates";
    }
    font_variant_alternates.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variant_alternates.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variant_alternates.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variant_alternates;
})(property);

_md.font_variant_alternates = font_variant_alternates;
// element font_variant_caps
var font_variant_caps = (function (property) {
    _inherits(font_variant_caps, property);
    function font_variant_caps(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variant_caps.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variant_caps);
        this.wzElement = "font_variant_caps";
    }
    font_variant_caps.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variant_caps.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variant_caps.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variant_caps;
})(property);

_md.font_variant_caps = font_variant_caps;
// element font_variant_east_asian
var font_variant_east_asian = (function (property) {
    _inherits(font_variant_east_asian, property);
    function font_variant_east_asian(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variant_east_asian.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variant_east_asian);
        this.wzElement = "font_variant_east_asian";
    }
    font_variant_east_asian.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variant_east_asian.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variant_east_asian.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variant_east_asian;
})(property);

_md.font_variant_east_asian = font_variant_east_asian;
// element font_variant_ligatures
var font_variant_ligatures = (function (property) {
    _inherits(font_variant_ligatures, property);
    function font_variant_ligatures(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variant_ligatures.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variant_ligatures);
        this.wzElement = "font_variant_ligatures";
    }
    font_variant_ligatures.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variant_ligatures.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variant_ligatures.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variant_ligatures;
})(property);

_md.font_variant_ligatures = font_variant_ligatures;
// element font_variant_numeric
var font_variant_numeric = (function (property) {
    _inherits(font_variant_numeric, property);
    function font_variant_numeric(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variant_numeric.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variant_numeric);
        this.wzElement = "font_variant_numeric";
    }
    font_variant_numeric.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variant_numeric.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variant_numeric.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variant_numeric;
})(property);

_md.font_variant_numeric = font_variant_numeric;
// element font_variant_position
var font_variant_position = (function (property) {
    _inherits(font_variant_position, property);
    function font_variant_position(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(font_variant_position.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, font_variant_position);
        this.wzElement = "font_variant_position";
    }
    font_variant_position.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    font_variant_position.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    font_variant_position.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return font_variant_position;
})(property);

_md.font_variant_position = font_variant_position;
// element font_variant
var font_variant = (function (property) {
    _inherits(font_variant, property);
    function font_variant(name, sourceLineInfo) {
...
_md.font_variation_settings = font_variation_settings;
// element gap
var gap = (function (property) {
    _inherits(gap, property);
    function gap(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(gap.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, gap);
        this.wzElement = "gap";
    }
    gap.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    gap.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    gap.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return gap;
})(property);
...
_md.margin = margin;
// element mask_image
var mask_image = (function (property) {
    _inherits(mask_image, property);
    function mask_image(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(mask_image.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, mask_image);
        this.wzElement = "mask_image";
    }
    mask_image.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    mask_image.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    mask_image.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return mask_image;
})(property);

_md.mask_image = mask_image;
// element max_height
...
// element overscroll_behavior
var overscroll_behavior = (function (property) {
    _inherits(overscroll_behavior, property);
    function overscroll_behavior(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(overscroll_behavior.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, overscroll_behavior);
        this.wzElement = "overscroll_behavior";
    }
    overscroll_behavior.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    overscroll_behavior.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    overscroll_behavior.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return overscroll_behavior;
})(property);

_md.overscroll_behavior = overscroll_behavior;
// element scrollbar_color
var scrollbar_color = (function (property) {
    _inherits(scrollbar_color, property);
    function scrollbar_color(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(scrollbar_color.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, scrollbar_color);
        this.wzElement = "scrollbar_color";
    }
    scrollbar_color.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    scrollbar_color.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    scrollbar_color.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return scrollbar_color;
})(property);

_md.scrollbar_color = scrollbar_color;
// element scrollbar_width
var scrollbar_width = (function (property) {
    _inherits(scrollbar_width, property);
    function scrollbar_width(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(scrollbar_width.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, scrollbar_width);
        this.wzElement = "scrollbar_width";
    }
    scrollbar_width.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    scrollbar_width.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    scrollbar_width.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return scrollbar_width;
})(property);

_md.scrollbar_width = scrollbar_width;
...
_md.scrollbar_width = scrollbar_width;
// element scroll_padding_top
var scroll_padding_top = (function (property) {
    _inherits(scroll_padding_top, property);
    function scroll_padding_top(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(scroll_padding_top.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, scroll_padding_top);
        this.wzElement = "scroll_padding_top";
    }
    scroll_padding_top.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    scroll_padding_top.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    scroll_padding_top.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return scroll_padding_top;
})(property);

_md.scroll_padding_top = scroll_padding_top;
...
var stroke_width = (function (property) {
    _inherits(stroke_width, property);
...
// element text_fill_color
var text_fill_color = (function (property) {
    _inherits(text_fill_color, property);
    function text_fill_color(name, sourceLineInfo) {
        _get(Object.getPrototypeOf(text_fill_color.prototype), 'constructor', this).call(this, name,sourceLineInfo);
        _classCallCheck(this, text_fill_color);
        this.wzElement = "text_fill_color";
    }
    text_fill_color.prototype.toJson = function() {
        var result = {};
        this.toJsonProperties(result);
        this.toJsonChildren(result);
        return result;
    }
    text_fill_color.prototype.toJsonProperties = function(result) {
        _md.property.prototype.toJsonProperties.call(this, result);
        if (this.__jsonProps) {
            for (var k in this.__jsonProps) {
                result[k] = this.__jsonProps[k];
    ...
    text_fill_color.prototype.toJsonChildren = function(result) {
        _md.property.prototype.toJsonChildren.call(this, result);
    }
    return text_fill_color;
})(property);

_md.text_fill_color = text_fill_color;
// element text_indent
...
var vttModelException = (function () {
    ...
    vttModelException.prototype.toString = function() {
        var msg = [];
        msg.push(chalk.red('Error: ' + this.message));
        msg.push(chalk.red('  name: vttModelException'));
        if (this.node) {
