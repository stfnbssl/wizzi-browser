...
var element = (function (htmlBase) {
    ...
    element.prototype.loadChild = function(child) {
        ...
        if (name === 'picture') {
            return this.wzLoadToChildColl(child, _md.picture, this.elements);
        }
        if (name === 'section') {
...
var img = (function (element) {
    ...
    img.prototype.loadChild = function(child) {
        ...
        if (name === 'loading') {
            this.loading = child.v; return true;
        }
        if (name === 'crossorigin') {
            this.crossorigin = child.v; return true;
        }
...
_md.param = param;
// element picture
var picture = (function (element) {
    _inherits(picture, element);
