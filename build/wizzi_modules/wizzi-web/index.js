...
md.__preload_html_model = require("./lib/wizzi/models/html-model.g");
md.__preload_html_factory = require("./lib/wizzi/models/html-factory.g");
md.__preload_html_document_gen = require("./lib/artifacts/html/document/gen/main");
md.__preload_css_model = require("./lib/wizzi/models/css-model.g");
md.__preload_css_factory = require("./lib/wizzi/models/css-factory.g");
md.__preload_css_document_gen = require("./lib/artifacts/css/document/gen/main");
md.__preload_scss_model = require("./lib/wizzi/models/scss-model.g");
md.__preload_scss_factory = require("./lib/wizzi/models/scss-factory.g");
md.__preload_scss_document_gen = require("./lib/artifacts/scss/document/gen/main");
md.__preload_svg_model = require("./lib/wizzi/models/svg-model.g");
md.__preload_svg_factory = require("./lib/wizzi/models/svg-factory.g");
md.__preload_svg_document_gen = require("./lib/artifacts/svg/document/gen/main");
md.__preload_md_model = require("./lib/wizzi/models/md-model.g");
md.__preload_md_factory = require("./lib/wizzi/models/md-factory.g");
md.__preload_md_document_gen = require("./lib/artifacts/md/document/gen/main");
md.__preload_graphql_model = require("./lib/wizzi/models/graphql-model.g");
md.__preload_graphql_factory = require("./lib/wizzi/models/graphql-factory.g");
md.__preload_graphql_document_gen = require("./lib/artifacts/graphql/document/gen/main");
md.__preload_site_model = require("./lib/wizzi/models/site-model.g");
md.__preload_site_factory = require("./lib/wizzi/models/site-factory.g");
md.__preload_vtt_model = require("./lib/wizzi/models/vtt-model.g");
md.__preload_vtt_factory = require("./lib/wizzi/models/vtt-factory.g");
md.__preload_vtt_document_gen = require("./lib/artifacts/vtt/document/gen/main");
md.__preload_vue_model = require("./lib/wizzi/models/vue-model.g");
md.__preload_vue_factory = require("./lib/wizzi/models/vue-factory.g");
md.__preload_vue_document_gen = require("./lib/artifacts/vue/document/gen/main");
//
...
var window_modelFactories = {
    ...
    site: require("./lib/wizzi/models/site-factory.g"), 
