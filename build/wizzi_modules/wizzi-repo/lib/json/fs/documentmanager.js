...
var DocumentManager = (function () {
    ...
    DocumentManager.prototype.createFolder = function(folderPath, callback) {
    ...
    DocumentManager.prototype.getFolder = function(folderPath, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    DocumentManager.prototype.getContentsByIds = function(ids, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
    ...
    DocumentManager.prototype.uploadFolder = function(sourcePath, destPath, options, callback) {
        if (verify.isFunction(callback) === false && verify.isFunction(options) === true) {
            callback = options;
            options = {};
        }
    ...
    DocumentManager.prototype.readFile = function(filePath, callback) {
        if (typeof(callback) !== 'function') {
            throw new Error(
...
function error(code, method, message, innerError) {
    ...
    return verify.error(innerError, {
        ...
        method: 'wizzi-repo.fs.json.DocumentManager.' + method,
        parameter: parameter,
